package com.androworld.freecode.model;
...
public class Symptoms {
    ...
    public Symptoms(int id2, int idsymptoms2, int uid2, String name2, String customname2, String imagename2, int nused2, int hidden2, int custom2) {
        this.id = id2;
        this.idsymptoms = idsymptoms2;
        this.uid = uid2;
        this.name = name2;
